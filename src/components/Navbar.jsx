    ...
    return (
        <nav className='p-4 bg-grayBg sticky top-0 z-50 shadow-sm border border-black'>
            <div className=' lg:w-4/5 mx-auto justify-between flex flex-row-reverse items-center lg:flex-row'>
                <a href="/" className="font-semibold text-red-500">DAM.<span className={`text-black`}>XY</span></a>
                ...
                <ul className="hidden md:flex gap-4 lg:gap-8 list-none items-center">
                    <li><a href="#about" className="text-black hover:text-[#2fff2f]">About Me</a></li>
                    <li><a href="#projects" className="text-black hover:text-[#2fff2f]">Projects</a></li>
                    <li><a href="#contact" className="text-black hover:text-[#2fff2f]">Contact</a></li>
                    <li>
            ...
            <div className={`absolute ${isMenu ? 'top-0 left-0' : '-left-[100vw]'}  w-full h-[100vh] z-5 md:hidden transition-all`}>
                ...
                <aside className="absolute top-0 left-0 w-3/5 h-[100vh] z-20 bg-white bg-opacity-100">
                    <svg viewBox="0 0 24 24" onClick={() => setIsMenu(false)} className="w-8 float-right m-4" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path fill-rule="evenodd" clip-rule="evenodd" d="M19.207 6.207a1 1 0 0 0-1.414-1.414L12 10.586 6.207 4.793a1 1 0 0 0-1.414 1.414L10.586 12l-5.793 5.793a1 1 0 1 0 1.414 1.414L12 13.414l5.793 5.793a1 1 0 0 0 1.414-1.414L13.414 12l5.793-5.793z" fill="#000000"></path></g></svg>

                    <ul className="flex flex-col mt-16 gap-4 list-none text-lg p-4">
                        <li><a href="#about" className="text-black hover:text-[#2fff2f]" onClick={()=>setIsMenu(false)}>About Me</a></li>
                        <li><a href="#projects" className="text-black hover:text-[#2fff2f]" onClick={()=>setIsMenu(false)}>Projects</a></li>
                        <li><a href="#contact" className="text-black hover:text-[#2fff2f]" onClick={()=>setIsMenu(false)}>Contact</a></li>
                        <li>
